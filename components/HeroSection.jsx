...
const HeroSection = () => {
    const HeroImage = "/images/FrontImage.png"
    const { size, elapsed, percentage, download,
        cancel, error, isInProgress } =
    useDownloader();
    const fileUrl = "/CV.pdf";
    const filename = "RaphaelRammCV.pdf";
        ...
        <section className="lg:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-12">
            ...
            >
              ...
              Welcome to my portfolio, where I showcase my creative journey and technical expertise.
              </p>
              <div>
                <Link
                  href="/contact"
                ...
                >
                  <span onClick={() => download(fileUrl, filename)} className="block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2">
                    Download CV
                  </span>
                </Link>
              </div>
